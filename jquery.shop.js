(function ($) {
	...
	$.Shop.prototype = {
		init: function () {
			...
			this.paypalBusinessEmail = "nchengsd@gmail.com"; 
		...
		// Handles the checkout form by adding validation and saving user's info into the session storage
		...
		// Fictional shipping rates calculation
